...
15. Local code review and repair turns stay on local source evidence. Web/search/browser MCP tools are blocked unless the user explicitly asks for external research.
