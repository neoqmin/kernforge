...
6. Focused review requests use a smaller evidence and prompt budget. Automatic pre-write review is diff-first and uses the proposed diff, edit proposal, and required repair findings before any broader context.
