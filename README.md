...
- `/model` is the model-routing hub for the main model, the analysis worker/reviewer, and specialist-subagent overrides. The primary review route follows the main model; only the optional cross review route is configured through `/review models`.
