...
func TestCompleteSlashSubcommandEnumeratedArguments(t *testing.T) {
	...
	cases := []struct {
		...
		{input: "/review models ", wantSuggest: []string{"/review models cross", "/review models status", "/review models clear"}},
		{input: "/review models cross op", wantBuffer: "/review models cross open"},
...
func TestCommandCompletionDescriptionCoversCommandsAndSubcommands(t *testing.T) {
	cases := map[string]string{
		...
		"/review models":                    "Show or change the independent cross-review route.",
		"/review models status":             "Show effective review routes, lenses, and automatic review settings.",
		"/review models cross":              "Configure the independent second-pass reviewer route.",
