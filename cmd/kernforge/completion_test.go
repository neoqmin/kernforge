...
func TestCompleteSlashSubcommandEnumeratedArguments(t *testing.T) {
	...
	cases := []struct {
		...
		{input: "/model cross-review ", wantSuggest: []string{"/model cross-review status", "/model cross-review 0", "/model cross-review openai-codex-subscription", "/model cross-review openai-codex-cli", "/model cross-review openai-api", "/model cross-review anthropic-claude-cli", "/model cross-review anthropic-api", "/model cross-review deepseek", "/model cross-review openrouter", "/model cross-review opencode", "/model cross-review opencode-go", "/model cross-review ollama", "/model cross-review lmstudio", "/model cross-review vllm", "/model cross-review llama.cpp", "/model cross-review open-webui"}},
