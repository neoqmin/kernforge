...
func TestCompleteSlashSubcommandEnumeratedArguments(t *testing.T) {
	...
	cases := []struct {
		...
		{input: "/review ", wantSuggest: []string{"/review change", "/review plan", "/review selection", "/review pr", "/review final", "/review goal", "/review analysis", "/review models", "/review --no-model", "/review --mode", "/review --follow-up", "/review --no-follow-up"}},
		...
		{input: "/review models ", wantSuggest: []string{"/review models primary", "/review models security", "/review models false-positive", "/review models design", "/review models regression", "/review models test", "/review models final", "/review models status", "/review models clear"}},
		{input: "/review models security op", wantBuffer: "/review models security open"},
...
func TestCommandCompletionDescriptionCoversCommandsAndSubcommands(t *testing.T) {
	cases := map[string]string{
		...
		"/review models":                    "Show or change role-specific reviewer model configuration.",
		"/review models status":             "Show effective reviewer models and automatic review settings.",
		"/review models security":           "Configure the security-boundary and abuse-risk reviewer role.",
